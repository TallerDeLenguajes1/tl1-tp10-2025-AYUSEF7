...
string CuerpoRespuesta = await respuesta.Content.ReadAsStringAsync(); // convierte el cuerpo de la respuesta a json pero en formato string para poder deserializarla y instanciarla en la clases necesaria
